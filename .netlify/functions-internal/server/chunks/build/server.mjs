globalThis.__timing__.logStart('Load chunks/build/server');import { toRef, isRef, hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { m as defuFn, o as klona, c as createError$1, q as hasProtocol, r as isScriptProtocol, s as joinURL, w as withQuery, t as sanitizeStatusCode, v as getContext, $ as $fetch$1, x as baseURL, y as createHooks, z as executeAsync, A as toRouteMatcher, B as createRouter$1, C as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BGXb-QiA.mjs')
  },
  {
    name: "track",
    path: "/track",
    component: () => import('./track-jS2TujhW.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-CT3kmJVN.mjs').then(r => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-EWOxdmJ1.mjs').then(m => m.default || m))
};
...
const stack = void 0;
const _Error404 = defineAsyncComponent(() => import('./error-404-Bh3S7vml.mjs'));
const _Error = defineAsyncComponent(() => import('./error-500-CFVcHT2-.mjs'));
...
export { _export_sfc as _, useAppConfig as a, useState as b, appConfig as c, useRoute as d, entry$1 as default, useRouter as e, useNuxtApp as f, useRuntimeConfig as g, nuxtLinkDefaults as h, asyncDataDefaults as i, createError as j, navigateTo as n, resolveRouteObject as r, useHead as u };;globalThis.__timing__.logEnd('Load chunks/build/server');
