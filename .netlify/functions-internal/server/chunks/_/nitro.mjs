...
const _RnIfSYNPywaY6TacCCv9wSStT2Gw2kpVNAfSgDOlfU = (function(nitro) {
...
const _LTqTlguLX7ywOHNJDpA1fbNXUV1YssOGkzqR18LbD0 = defineNitroPlugin((nitro) => {
...
const plugins = [
  _RnIfSYNPywaY6TacCCv9wSStT2Gw2kpVNAfSgDOlfU,
_LTqTlguLX7ywOHNJDpA1fbNXUV1YssOGkzqR18LbD0
];
...
const CLIENT_ID_VALIDITY = 900 * 1e3;
...
async function extractClientIdFromScripts() {
  try {
    ...
    const scriptUrls = Array.from(scriptMatches).map((match) => match[1]).slice(0, 2);
    for (const url of scriptUrls) {
      try {
        console.log("Checking script:", url);
        const scriptController = new AbortController();
        const scriptTimeoutId = setTimeout(() => scriptController.abort(), 5e3);
...
const _Q60mLp = defineCachedEventHandler(async (event) => {
...
const _lazy_GcdVLJ = () => import('../routes/api/health.mjs');
const _lazy_xUj35m = () => import('../routes/api/playlist.mjs');
const _lazy_eg_ebT = () => import('../routes/api/stream-mp3.mjs');
const _lazy_XhgGE3 = () => import('../routes/api/stream-url.mjs');
const _lazy_gla8cO = () => import('../routes/api/track-fallback.mjs');
const _lazy_cJ6CuE = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/health', handler: _lazy_GcdVLJ, lazy: true, middleware: false, method: undefined },
  { route: '/api/playlist', handler: _lazy_xUj35m, lazy: true, middleware: false, method: undefined },
  { route: '/api/stream-mp3', handler: _lazy_eg_ebT, lazy: true, middleware: false, method: undefined },
  { route: '/api/stream-url', handler: _lazy_XhgGE3, lazy: true, middleware: false, method: undefined },
  { route: '/api/track-fallback', handler: _lazy_gla8cO, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_cJ6CuE, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _Q60mLp, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_cJ6CuE, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, toRouteMatcher as A, createRouter$1 as B, defu as C, serialize$1 as D, isEqual as E, parseQuery as F, withTrailingSlash as G, withoutTrailingSlash as H, getQuery as a, getClientId as b, createError$1 as c, defineEventHandler as d, buildAssetsURL as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, joinHeaders as j, defineRenderHandler as k, getRouteRules as l, defuFn as m, normalizeCookieHeader as n, klona as o, publicAssetsURL as p, hasProtocol as q, isScriptProtocol as r, joinURL as s, sanitizeStatusCode as t, useNitroApp as u, getContext as v, withQuery as w, baseURL as x, createHooks as y, executeAsync as z };;globalThis.__timing__.logEnd('Load chunks/_/nitro');
