  ...
  <UApp class="dark">
    <div class="h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100 flex overflow-hidden">
      ...
      <Transition name="slide-left">
        <aside v-if="uiStore.showSettingsPanel"
          ...
          <!-- Settings Panel Header (Mobile only) -->
          ...
          <div class="flex-1 overflow-hidden min-h-0">
            <SettingsPanel @close="toggleSettingsPanel" />
          </div>
        </aside>
      </Transition>
          ...
          <div class="px-4 lg:px-6 h-16 flex items-center justify-between">
            <div class="flex items-center gap-4 lg:gap-8">
              <NuxtLink to="/" class="flex items-center gap-3 hover:scale-105 transition-transform">
                <svg class="w-6 h-6 lg:w-7 lg:h-7 text-orange-500" viewBox="0 0 24 24" fill="currentColor">
                ...
                <h1 class="text-lg lg:text-xl font-bold bg-gradient-to-r from-orange-500 to-pink-500 bg-clip-text text-transparent">
                  SoundCloud DL
                </h1>
              </NuxtLink>
              
              <nav class="hidden sm:flex items-center gap-4 lg:gap-6" role="navigation" aria-label="Main navigation">
                <NuxtLink 
                  to="/" 
            ...
            <div class="flex items-center gap-2 lg:gap-4">
              ...
              <button
                @click="toggleSettingsPanel"
                class="relative p-2 text-gray-400 hover:text-gray-300 transition-all hover:scale-110 rounded-lg hover:bg-gray-800/50"
                :class="{ 'text-gray-300': uiStore.showSettingsPanel }"
      ...
      <Transition name="fade">
        <div v-if="uiStore.showSettingsPanel" 
          class="sm:hidden fixed inset-0 bg-black/40 backdrop-blur-sm z-40"
          @click="toggleSettingsPanel"
          aria-hidden="true">
        </div>
