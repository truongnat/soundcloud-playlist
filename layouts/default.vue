...
// Computed for download statistics
...
// Provide the download handler to child components
...
// Restore queue state when mounted
onMounted(() => {
  // Check if there are downloads running or queued, don't auto-open panel
  // Only show indicator
})
</script>
