      ...
      <div class="flex-1 flex">
        ...
        <Transition name="slide">
          <div v-if="uiStore.showDownloadQueue"
            class="w-[450px] border-l border-gray-200 bg-white shadow-2xl fixed right-0 top-0 h-full z-50">
        ...
        <Transition name="fade">
          <div v-if="uiStore.showDownloadQueue" class="fixed inset-0 bg-black/20 backdrop-blur-sm z-40"
            @click="() => uiStore.showDownloadQueue = false"></div>
        </Transition>
